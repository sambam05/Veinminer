...
public final class RuleIndex {
    ...
    public static final class BlockRules {
        ...
        public static BlockRules of(Set<ResourceLocation> resourceLocations, Set<TagKey<Block>> tags) {
        ...
        public boolean matches(ResourceLocation id, Predicate<TagKey<Block>> tagMatcher) {
