...
public final class RuleIndex {
    ...
    public boolean isToolAllowed(ItemStack tool) {
        ...
        Identifier id = BuiltInRegistries.ITEM.getKey(tool.getItem());
    ...
    public static final class BlockRules {
        private final Set<Identifier> resourceLocations;
        private final Set<TagKey<Block>> tags;

        private BlockRules(Set<Identifier> resourceLocations, Set<TagKey<Block>> tags) {
