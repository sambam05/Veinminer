...
endlocal & (
    ...
    set "NFO_ALL_PROJECTS=VMM-neoforge-v1.21-v1.21.1 VMM-neoforge-v1.21.2-v1.21.4 VMM-neoforge-v1.21.5-v1.21.8 VMM-neoforge-v1.21.9-v1.21.10 VMM-neoforge-v1.21.11"
...
:emitUpload
endlocal & (
    REM NeoForge 1.20.x is intentionally unsupported (all-or-nothing policy).
    set "NEO_LEGACY_VERSIONS="
    set "NEO_VERSIONS=1.21 1.21.1 1.21.2 1.21.3 1.21.4 1.21.5 1.21.6 1.21.7 1.21.8 1.21.9 1.21.10 1.21.11"
    set "NEO_ALL_VERSIONS=1.21 1.21.1 1.21.2 1.21.3 1.21.4 1.21.5 1.21.6 1.21.7 1.21.8 1.21.9 1.21.10 1.21.11"
