...
if not defined VMM_BUILD_TIMEOUT_SECONDS set "VMM_BUILD_TIMEOUT_SECONDS=1200"

REM Load project lists from shared metadata.
...
echo Running Gradle with timeout %VMM_BUILD_TIMEOUT_SECONDS%s: gradlew.bat %GRADLE_ARGS_FOR_TIMEOUT%
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
  "$ErrorActionPreference = 'Stop';" ^
  "$timeout = [int]$env:VMM_BUILD_TIMEOUT_SECONDS;" ^
