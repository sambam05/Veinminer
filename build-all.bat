...
REM Project lists
REM NeoForge 1.20.x builds were dropped (no moddev bundle); only current supported versions remain.
...
REM Keep Fabric 1.20 through 1.21.10.
set FAB_PROJECTS=VMM-fabric-v1.20-v1.20.4 VMM-fabric-v1.20.5-v1.20.6 VMM-fabric-v1.21-v1.21.1 VMM-fabric-v1.21.2-v1.21.4 VMM-fabric-v1.21.5-v1.21.8 VMM-fabric-v1.21.9-v1.21.10
...
echo.
echo All builds complete. NeoForge: "%NFO_OUTPUT%"  Fabric: "%FAB_OUTPUT%"
goto :finish
