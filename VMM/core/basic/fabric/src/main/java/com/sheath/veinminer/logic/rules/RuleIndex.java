...
public final class RuleIndex {
    ...
    private final Set<Identifier> allowedToolIds;
    private final Set<TagKey<Item>> allowedToolTags;
    private final Map<Identifier, BlockRules> perToolIdRules;
    ...
    private RuleIndex(GeneralConfig.BlockListMode blockListMode,
                      ...
                      Set<Identifier> allowedToolIds,
                      Set<TagKey<Item>> allowedToolTags,
                      Map<Identifier, BlockRules> perToolIdRules,
    ...
    public static RuleIndex fromSnapshot(ConfigService.ConfigSnapshot snapshot) {
        ...
        Map<Identifier, BlockRules> perToolIds = new LinkedHashMap<>();
    ...
    public boolean isToolAllowed(ItemStack tool) {
        ...
        Identifier id = Registries.ITEM.getId(tool.getItem());
    ...
    public Map<Identifier, BlockRules> perToolIdRules() {
    ...
    public static final class BlockRules {
        ...
        private BlockRules(Set<Identifier> identifiers, Set<TagKey<Block>> tags) {
        ...
        public static BlockRules of(Set<Identifier> identifiers, Set<TagKey<Block>> tags) {
            Objects.requireNonNull(identifiers, "identifiers");
            Objects.requireNonNull(tags, "tags");
            return new BlockRules(Collections.unmodifiableSet(Set.copyOf(identifiers)),
                    Collections.unmodifiableSet(Set.copyOf(tags)));
        }

        public boolean matches(BlockState state) {
            Identifier id = Registries.BLOCK.getId(state.getBlock());
            return matches(id, state::isIn);
        }

        public boolean matches(Identifier id, Predicate<TagKey<Block>> tagMatcher) {
            return RuleMatcher.matches(id, identifiers, tags, tagMatcher);
        }
