...
public final class RuleIndex {
    ...
    private final Set<Object> allowedToolIds;
    private final Set<TagKey<Item>> allowedToolTags;
    private final Map<Object, BlockRules> perToolIdRules;
    ...
    private RuleIndex(GeneralConfig.BlockListMode blockListMode,
                      ...
                      Set<Object> allowedToolIds,
                      Set<TagKey<Item>> allowedToolTags,
                      Map<Object, BlockRules> perToolIdRules,
    ...
    public static RuleIndex fromSnapshot(ConfigService.ConfigSnapshot snapshot) {
        ...
        Map<Object, BlockRules> perToolIds = new LinkedHashMap<>();
    ...
    public boolean isToolAllowed(ItemStack tool) {
        ...
        Object id = BuiltInRegistries.ITEM.getKey(tool.getItem());
    ...
    public Map<Object, BlockRules> perToolIdRules() {
    ...
    public static final class BlockRules {
        private final Set<Object> resourceLocations;
        private final Set<TagKey<Block>> tags;

        private BlockRules(Set<Object> resourceLocations, Set<TagKey<Block>> tags) {
        ...
        public static BlockRules of(Set<Object> resourceLocations, Set<TagKey<Block>> tags) {
        ...
        public boolean matches(Object id, Predicate<TagKey<Block>> tagMatcher) {
            return RuleMatcher.matches(id, resourceLocations, tags, tagMatcher);
        }

        public Set<Object> resourceLocations() {
